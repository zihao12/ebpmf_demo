...
fit_ebpmf_exp_uniform_lee =  ebpmf_exponential_mixture_uniform(X, K = k, qg = qg_from_lee, m = 2^0.25,maxiter.out = iter_eb, init_method = "lee", low = 1e-10)
fit_ebpmf_exp_uniform_scd =  ebpmf_exponential_mixture_uniform(X, K = k, qg = qg_from_scd, m = 2^0.25,maxiter.out = iter_eb, init_method = "lee", low = 1e-10)
```
