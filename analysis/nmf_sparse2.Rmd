...
#fit_ebpmf_pg = ebpmf_point_gamma(X, K = k, maxiter.out = 100, init_method = "lee")
fit_ebpmf_exp = ebpmf_exponential_mixture(X, K = k, maxiter.out = 100, init_method = "lee")
...
#fit_ebpmf_pg = ebpmf::ebpmf_point_gamma(X, K = k, maxiter.out = 100, init_method = "lee")
fit_ebpmf_exp = ebpmf_exponential_mixture(X, K = k, maxiter.out = 100, init_method = "lee")
fit_ebpmf_exp_uniform =  ebpmf_exponential_mixture_uniform(X, K = k, m = 2^0.25,maxiter.out = 100, init_method = "lee", low = 1e-30)
```
