...
* Then I fit  EBPM with mixture of exponential as prior (our model knows the $b_k$). I compare $\ell(\pi)$, which should be better than oracle; I also compare $\ell(\lambda)$ (it is not clear whether the posterior  will be better than oracle, but still  we can use it  to see how good the model is). 
*  Then  I fit without the same model, without knowing the $b_k$. 
