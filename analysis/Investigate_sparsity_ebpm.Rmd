...
Here `ebpm_point_gamma` fails to capture the two modes. The much less sparisity makes $\pi_0$ much smaller. So the $gamma(shape, scale)$ has to compromise between large counts and very small counts. 
