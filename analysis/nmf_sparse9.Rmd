...
## Summary
The result (psoterior mean) is very similar to when we do not enforce scale-invariant, although we can see $\hat{g}$ are quite different. 
...
fit_ebpmf_gm = ebpmf.alpha::ebpmf_gamma_mixture(X = X,K = k,qg = qg_random, maxiter.out = 100, verbose = FALSE,theta_l = "max", theta_f = "max")
...
fit_ebpmf_gm_mle = ebpmf.alpha:: ebpmf_gamma_mixture(X = X,K = k,qg = qg_mle, maxiter.out = 100, theta_l = "max", theta_f = "max",verbose = FALSE)
