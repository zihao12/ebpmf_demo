...
## compare runtime
```{r}
t(list(lee = fit_lee$run.time[[3]], tg = fit_ebpmf_tg$runtime, pg = fit_ebpmf_pg$runtime))
```
...
dist = data.frame(cbind(rmse, js, kl, ll, elbo), row.names = c("oracle","mle", "two-gamma" ,"point-gamma"))
dist
```
